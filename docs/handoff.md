...
| -------------------------- | -------------------------- | ------------- | ------------------------------- |
| iPhone 17 Pro Max          | booted                     | `ldonald234`  | `e276a48` — before the SE fixes |
| iPhone 17 Pro              | booted                     | signed out    | `e276a48` — before the SE fixes |
| iPhone 17                  | booted                     | `ldonald0234` | `e276a48` — before the SE fixes |
