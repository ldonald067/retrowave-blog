...
- Tree-shaking pepicons cut the main bundle from 3,130 KB to 672 KB (-78%). Code
  splitting since brought it to **316 KB raw / 97 KB gzipped** (`index-*.js`),
  with vendor chunks split out — 948 KB of JS total. Measured 2026-08-20; re-run
  `npm run build` rather than trusting this number.
