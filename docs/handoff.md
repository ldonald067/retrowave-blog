...
| -------------------------- | -------------------------- | ------------- | ------------------ |
| iPhone 17 Pro Max          | booted                     | `ldonald234`  | current, `09dc20e` |
| iPhone 17 Pro              | booted                     | signed out    | current, `09dc20e` |
| iPhone 17                  | booted                     | `ldonald0234` | current, `09dc20e` |
| iPhone SE (3rd generation) | booted, created 2026-09-16 | signed out    | current, `09dc20e` |
